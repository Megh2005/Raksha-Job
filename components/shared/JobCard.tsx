...
const JobCard = ({ job }: JobsCardProps) => {
  return (
    <Link href={`/job/${job.id}`}>
      <div className="border w-[20rem] h-[17rem] p-3 rounded-md flex flex-col hover:bg-purple-600 outline-purple-600 outline transition duration-700 hover:text-white">
